...
Pod::Spec.new do |s|
  ...
  s.version      = "1.0.0"
  s.summary      = "Avoid Unexpected error"
  ...
  s.description  = <<-DESC
                   data safe data safe data safe data safe data safe
                   DESC
  ...
  # Or just: s.author    = "https://github.com/lianxiang1"
  # s.authors            = { "lianxiang1" => "237807878@qq.com" }
  # s.social_media_url   = "http://twitter.com/lianxiang1"
  ...
  s.source_files  = "Classes", "OCAvoidNilCate/*.{h,m}"
